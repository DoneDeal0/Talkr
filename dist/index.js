...
***************************************************************************** */exports.Talkr=function(t){var a=t.children,u=t.languages,o=t.defaultLanguage,l=t.detectBrowserLanguage,c=e.useState(l?n:o),s=c[0],i=c[1];return e.createElement(r.Provider,{value:{locale:s,setLocale:i,languages:u,defaultLanguage:o}},a)},exports.t=function(n,a){var u=e.useContext(r),o=u.locale,l=u.languages,c=u.defaultLanguage,s=l[l[o]?o:c],i=n;if(a&&Object.keys(a).includes("count")&&(i=0===a.count?n+".zero":1===a.count?n+".one":n+".many"),i.split(".").forEach((function(e){if(s[e])return s=s[e]})),"string"!=typeof s)return null;var g=a&&Object.entries(a).reduce((function(e,n){var r;return t(t({},e),((r={})[n[0]]=n[1].toString(),r))}),{});return g?s.split("__").map((function(e){return g[e]?g[e]:e})).join(""):s},exports.useLocale=function(){return e.useContext(r)};
